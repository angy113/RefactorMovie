...
public class Statement {
    ...
    public int calculateTotalFrequentRenterPoints() {
        ...
        rentals.forEach((final Rental rental) -> frequentRenterPoints[0] += rental.calculateFrequentRenterPoints());
    ...
    public double calculateTotalAmount() {
        ...
        rentals.forEach((final Rental rental) -> totalAmount[0] += rental.calculateAmount());
